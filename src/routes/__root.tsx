...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AIML Result Analysis Portal" },
      { name: "description", content: "Internal assessment result analysis for the AIML department." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "AIML Result Analysis Portal" },
      { property: "og:description", content: "Pass, fail, absentee and subject-wise result analysis." },
